...
class SkillsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create skill" do
    assert_difference('Skill.count') do
      post skills_url, params: { skill: { content: @skill.content, user_id: @skill.user_id } }
    end
  ...
  test "should update skill" do
    patch skill_url(@skill), params: { skill: { content: @skill.content, user_id: @skill.user_id } }
